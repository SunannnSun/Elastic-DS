...
####---------------------------------------------------------------------------------------------##########
#### For ELASTIC MOTION POLICY, we are only training one trajectory to ensure sequential GMM placement ####
####---------------------------------------------------------------------------------------------##########
...
def _pre_process(x, x_dot):
    """ 
    Shift to common attractor and roll out nested lists into a single array
